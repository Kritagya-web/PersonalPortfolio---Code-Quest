    ...
    card.addEventListener("click", () => {
      if (card.classList.contains("web")) {
        ...
        portfolioView({
          ...
          project_brief: `Logos designed during freetime trying to test my skills and learn adobe photoshop`,
        ...
        portfolioView({
          ...
          project_brief: `Graphics created just for the purpose of learning and creating stuff.`,
        ...
        portfolioView({
          ...
          project_brief: `Icons designed during freetime trying to test my skills and learn adobe photoshop`,
        ...
        portfolioView({
          ...
          project_brief: `Developed application for the user based upon the user requirement and tried to replicate the requirements as best as possible.`,
